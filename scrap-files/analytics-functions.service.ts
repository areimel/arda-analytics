 ...
 * 
 * For reusable analytics functionality, see: @/services/analytics.service.ts
 * For micro-services and utilities, see: @/services/analytics-micro-services/
 * 
 * TABLE OF CONTENTS:
 * ==================
 * 
 ...
 */
function logUTMDetection(adName: string, adKey: string, utmData: any): void {
 ...
 */
function handleGTMEventResult(eventDescription: string, result: any): void {
	if (!result.success) {
