import { GetUTMs, parameterLogger, UTMValues, ParameterData } from './analytics-micro-services/utm-tracking';
import { fieldDetection, fieldAdd, processAllForms, updateFormValues, UTMFormConfig } from './analytics-micro-services/utm-form';
import { pushToDataLayer, isGTMAvailable, GTMPushResult } from './analytics-micro-services/gtm-event-push';
import { 
	UserJourneyTrigger,
	getRecentEvents,
	hasEventOccurred,
